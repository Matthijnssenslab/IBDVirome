...
####################################
# 5.6 Bacteriocin-containing contigs
####################################
...
#View(Mastertable)
####################################
# 10. Additional information to Mastertable
####################################
# 10.1 Insert length of contigs
####################################
...
# View(Mastertable)
####################################
# 10.2 Insert gene length (kb) ratio of contigs
####################################
Mastertable$GeneLengthRatio <- (Mastertable$`total genes`/Mastertable$length)
# view(Mastertable)
####################################
# 10.3 Insert total gene to viral gene ratio of contigs (~ estimate of how many genes of the total are viral)
####################################
Mastertable$ViralGeneLengthRatio <- (Mastertable$`viral genes`/Mastertable$length)
####################################
# 10.4 Insert total number of trimmed reads per contig; and additional information
####################################
# 10.4.1 Total Nr. of reads
####################################
...
# How many phages genera are found?
####################################
# 13.2.10 alignment quality (ANI, coverage)
####################################
...
####################################
# 14. Additional Cenote-Taker2 Taxonomical information: 1 hallmark gene
####################################
